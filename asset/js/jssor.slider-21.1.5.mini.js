(function(k, f, c, j, d, l, h) { /*! Jssor */
    ...
    var b = k.$Jssor$ = new function() {
        ...
        g.wg = function(a, b) {
            var c = g.Bd(a);
            b & 1 && g.s(a, (g.l(c) - g.l(a)) / 2);
            b & 2 && g.v(a, (g.m(c) - g.m(a)) / 2)
        };
        g.zc = function(b, a) {
                ...
                b.a(h, function(G) {
                    ...
                    if (a.$Zoom || a.$Rotate) {
                        ...
                        if (H) {
                            ...
                            f.$Zoom = 1;
                            if (b.gb() || b.Dd()) e.$Zoom = c.min(e.$Zoom, 2);
                            var N = a.$Rotate || 0;
    ...
    var i = k.$JssorSlider$ = function(p, hc) {
        ...
        var rb = a.$BulletNavigatorOptions,
            ...
            Q = !a.$UISearchMode,
            y, v = b.z(p, "slides", Q),
            cb = b.z(p, "loading", Q) || b.ib(f),
            Jb = b.z(p, "navigator", Q),
            ec = b.z(p, "arrowleft", Q),
            cc = b.z(p, "arrowright", Q),
            Hb = b.z(p, "thumbnavigator", Q),
            pc = b.l(v),
            oc = b.m(v),
            V, T = [],
            yc = b.Ab(v);
        ...
        if (r) {
            ...
            var xb = v,
                ...
                kb = Fb.Wf,
                G, qb, Kb, tb;
            Fb.nd && b.Z(xb, Fb.nd, ([j, "pan-y", "pan-x", "none"])[Y] || "");
            U = new Dc;
        ...
        f.wc = function(E) {
            if (!u) {
                ...
                for (var f = 0; f < s; f++) {
                    ...
                    b.C(e, l);
                    B[f] = l;
                    a.$ActionMode & 1 && b.c(l, "click", b.G(j, t, f));
                    a.$ActionMode & 2 && b.c(l, "mouseover", b.Sb(b.G(j, t, f), l));
                    y[f] = b.Tb(l)
                }
                u = d
            }
    ...
    k.$JssorArrowNavigator$ = function(a, g, h) {
        ...
        c.wc = function(c) {
            ...
            e = 0;
            if (!m) {
                b.c(a, "click", b.G(j, k, -i));
                b.c(g, "click", b.G(j, k, i));
                b.Tb(a);
                b.Tb(g);
                m = d
            }
    ...
    k.$JssorThumbnailNavigator$ = function(g, B) {
        ...
        function A(n, f) {
            ...
            m = b.Tb(c);
            a.$ActionMode & 1 && b.c(c, "click", b.G(j, i, 0));
            a.$ActionMode & 2 && b.c(c, "mouseover", b.Sb(b.G(j, i, 1), c))
        }
        h.Ec = function(b, d, f) {
            var a = p;
            p = b;
